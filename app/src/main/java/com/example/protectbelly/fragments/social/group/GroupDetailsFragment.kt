...
class GroupDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.goBackToSocial).setOnClickListener {
            findNavController().navigate(R.id.action_groupDetailsFragment_to_socialDetailsFragment)
        }

        view.findViewById<Button>(R.id.goToLeaderboard).setOnClickListener {
            findNavController().navigate(R.id.action_groupDetailsFragment_to_leaderboardDetailsFragment)
        }
    }
